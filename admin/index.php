	    ...
	    <div class="main-panel">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								<a href="new-user.php" class="dropdown-toggle" >
			...
			<div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="glyphicon glyphicon-plus-sign"></i> <a href="add-dep.php">add new</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="glyphicon glyphicon-plus"></i> <a href="withdraw.php">withdraw</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="glyphicon glyphicon-plus"></i> <a href="loan.php"> Loan out</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="glyphicon glyphicon-plus"><a href="payment.php"> Make payment</a></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- -->
                    ...
                    ?>
                        <div class="card">
                            <button type="submit" class="btn btn-block btn-google" style="background:cadetblue;" name="add" >LOAN LIST</button>
